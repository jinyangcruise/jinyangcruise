...
Indie Game Developer • Godot Engine Contributor

Making free & open-source Godot plugins for the community.
- 🎮 Making small games & tools with Godot Engine
- 🧩 Building & maintaining open-source plugins for Godot devs
- 🤝 Welcome to contribute, report issues or give suggestions
...
- CC Allow - Auto allow Claude Code Desktop for users.
